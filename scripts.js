...
console.log(
  "the Number of Seats available of the plane are" + availableFlightSeats
);

console.log("Step 2:  Cost of Groceries");
var costOfGroceries = 100.0;
console.log("Cost of Groceries is " + costOfGroceries);

console.log("Step 3:  Middle Initial");
var middleInital = "A";
console.log("My middle inital is " + middleInital);

console.log("Step 4:  Is it Hot Outside?");
var temperature = "Yes";
console.log("Is it hot outside? " + temperature);
...
var streetAddress = "5214 W Carold Ave";
...
//  ↓ YOUR CODE HERE ↓
console.log(
  "A customer booked 2 seats,leaving " +
...
//  ↓ YOUR CODE HERE ↓
console.log("Your new tolal is " + (costOfGroceries + 2.15));
...
console.log();
middleInital = "AA";
console.log("My birth certificate needs to be updated to " + middleInital);
...
//  ↓ YOUR CODE HERE ↓
var fullName = firstName + " " + middleInital + " " + "DeJordy";
